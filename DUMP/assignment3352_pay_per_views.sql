...
CREATE TABLE `pay_per_views` (
  ...
  PRIMARY KEY (`match_location`,`match_date`),
  CONSTRAINT `pay_per_views_ibfk_1` FOREIGN KEY (`match_location`, `match_date`) REFERENCES `matches` (`location`, `match_date`) ON DELETE CASCADE
...
INSERT INTO `pay_per_views` VALUES (0.00,'Online','2022-12-13'),(0.00,'Online','2022-12-14'),(0.00,'Online','2022-12-15'),(0.00,'Online','2022-12-16');
...
-- Dump completed on 2022-12-05 19:52:14
